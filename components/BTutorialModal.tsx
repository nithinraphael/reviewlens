          ...
          <div className="grid h-full grid-cols-[0.95fr_1.05fr]">
            <div className="relative flex min-h-0 flex-col border-r border-black/8 px-8 py-8">
              ...
              <div className="max-w-xl">
                <div className="text-[11px] uppercase tracking-[0.36em] text-black/34">Tutorial</div>
                <h2 className="mt-3 text-[3.1rem] font-semibold tracking-[-0.05em] leading-[0.95] text-black">How ReviewLens works</h2>
                <p className="mt-4 text-[16px] leading-7 text-black/62">
                  A fast analyst workspace for turning public review pages into a brief, a grounded Q&amp;A surface, and a shareable report.
                </p>
              </div>
                ...
                {kTutorialSteps.map(({ label, title, body }, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="text-[17px] font-medium tracking-tight text-black">{title}</div>
                        <p className="mt-1.5 text-[14px] leading-6 text-black/58">{body}</p>
                      </div>
                    </div>
                  </motion.div>
                ))}
            ...
            <div className="relative min-h-0 overflow-hidden px-8 py-8">
              ...
              <div className="text-[11px] uppercase tracking-[0.36em] text-black/34">Visual flow</div>
              <h3 className="mt-3 max-w-[28rem] text-[2.4rem] font-semibold tracking-[-0.04em] leading-[0.96] text-black">From source page to executive-ready output</h3>
              ...
              <div className="relative mt-6 overflow-hidden rounded-[30px] border border-black/8 bg-[linear-gradient(180deg,#fbfaf7_0%,#f6f2ea_100%)] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.75)]">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                  <motion.div
                    ...
                    className="rounded-[22px] border border-black/8 bg-white/82 p-4 shadow-[0_10px_24px_rgba(18,18,18,0.04)]"
                    transition={{ duration: 2.4, repeat: Number.POSITIVE_INFINITY }}
                  >
                    <div className="text-[11px] uppercase tracking-[0.28em] text-black/34">Guardrails</div>
                    <div className="mt-2.5 text-[15px] leading-6 text-black/66">
                      Prompts are filtered for unsafe content and checked for review-only scope before the answer stream begins.
                    </div>
                  </motion.div>
                  <motion.div
                    animate={{ opacity: [0.72, 1, 0.72] }}
                    className="rounded-[22px] border border-black/8 bg-white/82 p-4 shadow-[0_10px_24px_rgba(18,18,18,0.04)]"
                    transition={{ duration: 2.6, delay: 0.2, repeat: Number.POSITIVE_INFINITY }}
                  >
                    <div className="text-[11px] uppercase tracking-[0.28em] text-black/34">Modes</div>
                    <div className="mt-2.5 text-[15px] leading-6 text-black/66">
                      Analyst mode stays close to evidence. Exec mode compresses the signal into business implications and decision-ready framing.
                    </div>
                  </motion.div>
                </div>
              </div>
